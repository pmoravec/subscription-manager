...
def pre_check_status(force_signal):
    ...
    :param force_signal: When this is not None, then this value is returned and this signal si
...
class StatusChecker(dbus.service.Object):
    ...
    def __init__(self, bus, keep_alive, force_signal, loop):
        ...
        ga_GObject.timeout_add_seconds(self.TIMEOUT, timout_cb, loop, self)
...
def main():
    ...
    """
    debug("rhsmd started")
    log.warning("D-Bus API: com.redhat.SubscriptionManager provided by rhsmd is deprecated")
    log.warning("Consider using D-Bus API: com.redhat.RHSM1 provided by rhsm.service")
